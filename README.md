...
pixi add r-opdisdownsampling
# for installing globally
pixi global install r-opdisdownsampling
```
...
It is possible to list all of the versions of `r-opdisdownsampling` available on your platform:
...
```
pixi search r-opdisdownsampling --channel conda-forge
```
